...
%        John Cunningham  jcunnin@stanford.edu
  ...
  switch params.covType
    case 'rbf'
      ...
      fname     = 'embedding.GPFA.core_gpfa.grad_betgam';
    case 'tri'
      oldParams = params.a;
      fname     = 'grad_trislope';
    case 'logexp'
  ...
  precomp = embedding.GPFA.util.precomp.makePrecomp(seq, xDim);
  ...
  for i = 1:xDim
    ...
    embedding.GPFA.util.minimize(initp, fname, MAXITERS, precomp(i), const);
